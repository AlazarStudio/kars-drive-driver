...
// Простейшие мок-данные
const initial = [
    { id: "d1", type: "date", text: "17 мая 2024" },
    { id: "m1", type: "in", author: "Алим", text: "Здравствуйте!", time: "17:27" },
    { id: "m2", type: "out", text: "Здравствуйте!", time: "17:31" },
];
...
export default function SupportScreen() {
    ...
    const send = () => {
        ...
        setMessages((prev) => [
            ...prev,
            { id: String(Math.random()), type: "out", text: value, time: `${hh}:${mm}` },
        ]);
        setText("");
    ...
    const renderItem = ({ item }) => {
        ...
        return (
            <View style={[styles.msgRow, isOut ? styles.rowOut : styles.rowIn]}>
                {/* подпись автора слева у входящих */}
    ...
    return (
        <SafeAreaView style={styles.safe} edges={["top"]}>
            {/* Header внутри экрана (в табах скрыт системный) */}
            ...
            >
                <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
                    <View style={{ flex: 1 }}>
                        ...
                        {/* Панель ввода (сидит прямо над таббаром) */}
